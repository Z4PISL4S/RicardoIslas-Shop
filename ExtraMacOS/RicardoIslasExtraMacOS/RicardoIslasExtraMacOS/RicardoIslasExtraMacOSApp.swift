            ...
            VStack(spacing: 20) {
                ...
                VStack(alignment: .leading) {
                    HStack {
                        ...
                        .font(.subheadline)
                        .foregroundColor(Color.green.opacity(0.8)) // Verde más oscuro
                    }
                    .padding(.horizontal)
...
struct CategoryScrollView: View {
    let categories: [Category] = [
        Category(name: "Fruits", imageUrl: "https://freepng.com/uploads/images/202311/Fruits-vector-cartoon-png_600x-3803.jpg"),
        Category(name: "Bread", imageUrl: "https://placehold.co/80x80/FFF3E0/000000?text=Bread"),
        Category(name: "Vegetable", imageUrl: "https://placehold.co/80x80/E8F5E9/000000?text=Veg"),
        Category(name: "Fish", imageUrl: "https://placehold.co/80x80/E1F5FE/000000?text=Fish"),
        Category(name: "Meat", imageUrl: "https://placehold.co/80x80/FBE9E7/000000?text=Meat"),
        Category(name: "Drinks", imageUrl: "https://placehold.co/80x80/E3F2FD/000000?text=Drink"),
        Category(name: "Sea Food", imageUrl: "https://placehold.co/80x80/E0F7FA/000000?text=Seafood"),
        Category(name: "Ice Cream", imageUrl: "https://placehold.co/80x80/FCE4EC/000000?text=Ice"),
        Category(name: "Juice", imageUrl: "https://placehold.co/80x80/FFFDE7/000000?text=Juice"),
        Category(name: "Jam", imageUrl: "https://placehold.co/80x80/F3E5F5/000000?text=Jam")
    ]
...
struct CategoryButton: View {
    ...
    var body: some View {
        VStack {
            // Usar AsyncImage para cargar desde URL
            AsyncImage(url: URL(string: category.imageUrl)) { phase in
                if let image = phase.image {
                    ...
                    // Fallback para error de carga: Rectángulo gris con icono de error
                    Rectangle()
                    ...
                    // Placeholder mientras carga: Rectángulo gris con ProgressView
                    Rectangle()
...
struct DiscountShopView: View {
    let discounts: [Discount] = [
        Discount(percentage: "35% Discount", description: "Order any food from app and get the discount", imageUrl: "https://placehold.co/150x120/4CAF50/FFFFFF?text=35%25+OFF"),
        Discount(percentage: "20% Discount", description: "Order any food from app and get the discount", imageUrl: "https://placehold.co/150x120/8BC34A/FFFFFF?text=20%25+OFF"),
        Discount(percentage: "20% Discount", description: "Order any food from app and get the discount", imageUrl: "https://placehold.co/150x120/689F38/FFFFFF?text=20%25+OFF"),
        Discount(percentage: "10% Discount", description: "Order any food from app and get the discount", imageUrl: "https://placehold.co/150x120/7CB342/FFFFFF?text=10%25+OFF")
    ]
...
struct DiscountCard: View {
    ...
    var body: some View {
        ...
        .background(
            // Usar AsyncImage para cargar desde URL como fondo
            AsyncImage(url: URL(string: discount.imageUrl)) { phase in
                if let image = phase.image {
                    image
                        .resizable()
                        .scaledToFill()
                    ...
                    // Fallback para error de carga: Rectángulo gris oscuro con texto de error
                    Rectangle()
...
struct LastOrderView: View {
    let lastOrders: [Order] = [
        Order(productName: "Red Saffron", price: 150.00, quantity: "500 gm", imageUrl: "https://placehold.co/50x50/FFEB3B/000000?text=Saffron"),
        Order(productName: "Fresh Apple", price: 120.00, quantity: "2 kg", imageUrl: "https://placehold.co/50x50/F44336/FFFFFF?text=Apple"),
        Order(productName: "Big Fish", price: 300.00, quantity: "6 kg", imageUrl: "https://placehold.co/50x50/2196F3/FFFFFF?text=Fish")
    ]
...
// Se cambió 'imageName' a 'imageUrl' en todas las structs

struct Category: Identifiable {
    let id = UUID()
    let name: String
    let imageUrl: String // Ahora es una URL
}
...
let popularProducts = [
    Product(name: "Strawberry", price: 20.10, imageUrl: "https://images.unsplash.com/photo-1575936123452-b67c3203c357?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aW1hZ2V8ZW58MHx8MHx8fDA%3D1"),
    Product(name: "Cabbage", price: 15.10, imageUrl: "https://placehold.co/150x100/8BC34A/000000?text=Cabbage"),
    Product(name: "Broccoli", price: 25.10, imageUrl: "https://placehold.co/150x100/4CAF50/FFFFFF?text=Broccoli"),
    Product(name: "Orange", price: 12.10, imageUrl: "https://placehold.co/150x100/FF9800/000000?text=Orange"),
    Product(name: "Fresh Apple", price: 18.10, imageUrl: "https://placehold.co/150x100/F44336/FFFFFF?text=Apple")
]
