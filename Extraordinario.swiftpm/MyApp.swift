...
struct CategoryScrollView: View {
    let categories: [Category] = [
        Category(name: "Fruits", imageName: "fruit"),
        Category(name: "Bread", imageName: "bread"),
        Category(name: "Vegetable", imageName: "vegetable"),
        Category(name: "Fish", imageName: "fish"),
        Category(name: "Meat", imageName: "meat"),
        Category(name: "Drinks", imageName: "drink"),
        Category(name: "Sea Food", imageName: "seafood"),
        Category(name: "Ice Cream", imageName: "icecream"),
        Category(name: "Juice", imageName: "juice"),
        Category(name: "Jam", imageName: "jam")
    ]
...
struct CategoryButton: View {
    ...
    var body: some View {
        VStack {
            // Usar una imagen de SF Symbols o de tus Assets
            Image(category.imageName) // Asegúrate de tener estas imágenes en tus Assets
                .resizable()
                .scaledToFit()
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ZStack(alignment: .topTrailing) { // Para el icono de corazón
                Image(product.imageName) // Asegúrate de tener estas imágenes en tus Assets
                    .resizable()
                    .scaledToFill() // Usar fill para que la imagen ocupe el espacio
...
struct DiscountShopView: View {
    let discounts: [Discount] = [
        Discount(percentage: "35% Discount", description: "Order any food from app and get the discount", imageName: "discount1"),
        Discount(percentage: "20% Discount", description: "Order any food from app and get the discount", imageName: "discount2"),
        Discount(percentage: "20% Discount", description: "Order any food from app and get the discount", imageName: "discount3"),
        Discount(percentage: "10% Discount", description: "Order any food from app and get the discount", imageName: "discount4")
    ]
...
struct DiscountCard: View {
    ...
    var body: some View {
        ...
        .background(
            Image(discount.imageName) // Asegúrate de tener estas imágenes en tus Assets
                .resizable()
                .scaledToFill()
                .clipped()
...
struct LastOrderView: View {
    let lastOrders: [Order] = [
        Order(productName: "Red Saffron", price: 150.00, quantity: "500 gm", imageName: "saffron"), // Cambiado a "gm"
        Order(productName: "Fresh Apple", price: 120.00, quantity: "2 kg", imageName: "apple"), // Cambiado a "kg"
        Order(productName: "Big Fish", price: 300.00, quantity: "6 kg", imageName: "fish_order") // Cambiado a "kg"
    ]
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ForEach(lastOrders) { order in
                HStack {
                    Image(order.imageName) // Asegúrate de tener estas imágenes en tus Assets
                        .resizable()
                        .scaledToFit()
...
struct Discount: Identifiable {
    ...
    let imageName: String // Nombre de la imagen de fondo del banner
}
...
struct Order: Identifiable {
    ...
    let price: Double
    let quantity: String // Ej. "500g", "1kg"
    let imageName: String // Imagen del producto en el pedido
}

let popularProducts = [
    Product(name: "Strawberry", price: 20.10, imageName: "strawberry"),
    Product(name: "Cabbage", price: 15.10, imageName: "cabbage"),
    Product(name: "Broccoli", price: 25.10, imageName: "broccoli"),
    Product(name: "Orange", price: 12.10, imageName: "orange"),
    Product(name: "Fresh Apple", price: 18.10, imageName: "apple")
]
